...
the most recent being the successful 3500-capacity OHM 2013 festival last year
in the Netherlands.
...
significant experience running similar events across Europe, including the 3500-capacity OHM 2013.
...
The event site is not in direct proximity to any residential areas - the nearest residential properties are approximately
900m to the south-west and 1.5km to the north-west of the site - and is located in a natural dip in the land.
...
during the event, and due to the location of the site within the Hounslow Hall estate, leaving the site on foot
will be strongly discouraged.

Because of this, there is a very low risk of attendees causing public nuisance outside the site.
...
at least once before 2300 and once after 2300 each day, whenever there is amplified music being played.
...
and vehicles will not be allowed on site without a pass. A shuttle bus service will be provided between the site and Bletchley station.

Around 500 vehicles are expected to park on site, although the capacity of the car parking fields is in excess of 1000.
Some of the car parking fields are located some distance away from the festival site, and if these are used, a shuttle
service will run between the two locations.

\subsection{Approach Routes}

The published approach route for attendees arriving by car from the M1 or the South will be along the A4146,
then towards Drayton Parslow, turning right at the Drayton Parslow crossroads onto Newton Road/Drayton Road, and then
left into the access road to Hounslow Hall. This will avoid directing traffic through Bletchley and Newton Longville.
...
The sole means of access to the site is from a single access road off Drayton Road, with a length of approximately 1.5km.
While cars are arriving, stewards will be posted to marshall the traffic.

There is a gate which controls access to Hounslow Hall Estate, which will be closed during off-peak hours. The gate can
be remotely operated by staff if vehicles need to be allowed onto site. The telephone number for the site office will be
posted at this gate and will be made available to emergency services on request.
